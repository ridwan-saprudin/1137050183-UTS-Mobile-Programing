...
public class login extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Login button
        btnLogin = (Button) findViewById(R.id.btOk);
            ...
            public void onClick(View arg0) {
                ...
                if(username.trim().length() > 0 && password.trim().length() > 0){
                    ...
                    if(username.equals("admin") && password.equals("admin")){
                        ...
                        // Use user real data
                        session.createLoginSession("ridwan", "admin");
        ...
        Button btnLupa = (Button) findViewById(R.id.btLupa);

        btnLupa.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {
                Toast.makeText(login.this, "Username anda : Admin , Password anda = admin ",
